...
var _assert = __webpack_require__(10201);
// EXTERNAL MODULE: ./node_modules/@noble/hashes/esm/utils.js + 1 modules
var utils = __webpack_require__(32875);
 ...
 */
const sha256_sha256 = /* @__PURE__ */ (0,utils/* wrapConstructor */.hE)(() => new SHA256());
...
var abstract_utils = __webpack_require__(45495);
...
function mapHashToField(key, fieldOrder, isLE = false) {
    ...
    const num = isLE ? (0,abstract_utils.bytesToNumberBE)(key) : (0,abstract_utils/* bytesToNumberLE */.ty)(key);
    // `mod(x, 11)` can sometimes produce 0. `mod(x, 10) + 1` is the same, but no 0
    const reduced = modular_mod(num, fieldOrder - _1n) + _1n;
    return isLE ? (0,abstract_utils/* numberToBytesLE */.S5)(reduced, fieldLen) : (0,abstract_utils/* numberToBytesBE */.tL)(reduced, fieldLen);
}
